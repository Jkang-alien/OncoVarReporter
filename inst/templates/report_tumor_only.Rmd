...
1. ExAC filtering (MAF in any population > 0.1%): __`r report_data$filter1_n`__ (__`r report_data$filter1_frac`__ % of all calls)
2. 1000 Genomes Project filtering (MAF in any population > 1%): __`r report_data$filter2_n`__ (__`r report_data$filter2_frac`__ % of all calls)
3. dbSNP (non-clinically-related) filtering: __`r report_data$filter3_n`__ (__`r report_data$filter3_frac`__ % of all calls)
